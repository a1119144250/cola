...
import com.xiaowang.cola.api.user.response.data.InviteRankInfo;
import com.xiaowang.cola.base.exception.BizException;
import com.xiaowang.cola.base.exception.RepoErrorCode;
...
import com.xiaowang.cola.user.domain.entity.convertor.UserConvertor;
import com.xiaowang.cola.user.infrastructure.exception.UserErrorCode;
import com.xiaowang.cola.user.infrastructure.exception.UserException;
...
import static com.xiaowang.cola.user.infrastructure.exception.UserErrorCode.DUPLICATE_TELEPHONE_NUMBER;
import static com.xiaowang.cola.user.infrastructure.exception.UserErrorCode.NICK_NAME_EXIST;
import static com.xiaowang.cola.user.infrastructure.exception.UserErrorCode.USER_AUTH_FAIL;
import static com.xiaowang.cola.user.infrastructure.exception.UserErrorCode.USER_NOT_EXIST;
import static com.xiaowang.cola.user.infrastructure.exception.UserErrorCode.USER_STATUS_CANT_OPERATE;
import static com.xiaowang.cola.user.infrastructure.exception.UserErrorCode.USER_STATUS_IS_NOT_ACTIVE;
